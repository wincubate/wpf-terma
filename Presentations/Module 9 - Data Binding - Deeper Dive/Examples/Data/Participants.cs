...
namespace Wincubate.DataBindingDeeperDiveExamples.Data
{
    public class Participants : List<Participant> // ObservableCollection
    {
        public Participants()
        {
            this.Add( new Participant( "Gulmann Henriksen",
                                       "Jesper",
                                       "Wincubate ApS",
                                       new Uri( "pack://application:,,,/Wincubate.DataBindingDeeperDiveExamples.Data;component/JGH.jpg" ) ) );
        ...
        public Participants( int number )
        {
            for( int i = 0; i < number; i++ )
            {
                this.Add( new Participant( "Deltagersen",
                                          "Deltager" + i,
                                          "Virksomhed",
                                          new Uri( "pack://application:,,,/Wincubate.DataBindingDeeperDiveExamples.Data;component/nophoto.gif" ) ) );
            }
        }
